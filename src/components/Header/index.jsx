...
import logoWhite from '../../assets/Pagamentos-white.png'
export default function IndexPage() {
    ...
    return (
            ...
            <div className="bg-white-200">
                ...
                <nav>
                    <div className="py-2 px-3 w-full flex sm:hidden justify-between items-center bg-white top-0 z-40">
                    ...
                    <div className={show ? "w-full sm:hidden h-full absolute z-40  transform  translate-x-0 " : "   w-full xl:hidden h-full absolute z-40  transform -translate-x-full"}>
                                    ...
                                    <div>
                                        <div className="mt-6 flex w-full items-center justify-between">
                                            <div className="flex items-center justify-between w-full">
                                                <div className="flex items-center">
                                                    <img src={payLogo}  width = "120px" alt="" srcset="" />
                                                </div>
